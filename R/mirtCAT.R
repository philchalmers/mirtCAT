...
#'   until a variable response pattern is observed. However, for selection purposes the 
#'   posterior weighting schemes are generally more stable and therefore should be prefered.
#'   
