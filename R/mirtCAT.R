...
#'     
#'   \item{\code{instructions}}{A character string indicating how to use the GUI. Default is: 
#'   
#'     \preformatted{"To progress through the interface, click on the button below."}
#'   }
#'
