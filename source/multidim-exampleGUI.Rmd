...
50 items have been administered. Also, omit the demographics page by passing an empty list.

```{r, eval=FALSE}
result <- mirtCAT(shiny_questions, mod, criteria = 'Drule', item_answers = answers,
                  design = list(min_SEM = 0.4, max_items = 50),
                  shinyGUI = list(demographics = list()))
print(result)
plot(result)
