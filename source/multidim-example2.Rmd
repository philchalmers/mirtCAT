...
benefits of using a MIRT model as opposed to separate unidimensional models (especially after 
...
input so that the `subset` argument to `findNextItem()` can be manipulated. Here we define two blocks to select
